...
To create a versioned release, simply create a Release in GitHub. Be sure the tag is in the format `X.Y.Z`,
this will become the version number of the new release. DO NOT edit the version number in `openapi.yaml`,
this is done automatically by the build process.
